  ...
  <div>
    ...
    <el-card class="box-card" style="margin:20px 20px 0 20px;">
      ...
      <el-col style="margin-bottom:5px;margin-top:5px" :span="24">
        ...
        <el-col :span="2">
          <el-button type="success" size="small"  style="margin-left:10px;font-size:13px" @click="firstAddUserDia()">
            <i style="padding-right:10px" class="el-icon-top"></i>返回上一界面
          </el-button>
        </el-col>
        
        <el-col hidden style="margin-left:10px;" :span="2">
...
export default {
  ...
  methods: {
    firstAddUserDia() {
      this.$router.push({ name: "fillingunit" });
    },
    showAddUserDia() {
