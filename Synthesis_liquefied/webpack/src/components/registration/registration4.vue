    ...
    <el-card class="box-card" style="margin:20px 20px 0 20px;">
      ...
      <template>
        ...
        >
          ...
          <el-table-column show-overflow-tooltip prop="licence" label="检验核准证书编号"></el-table-column>
      ...
      >
        <el-form @keyup.enter.native="EditUser" :model="editUserForm" :rules="rulses">
          ...
          <el-col :span="24">
            ...
            <el-col :span="8">
              <el-form-item label="检验核准证书编号:" label-width="140px" prop="licence">
...
export default {
  ...
  methods: {
    ...
    // 查询单位名称
    async selectedDia() {
      const res = await this.$http.get(`/unit/findByUnitType/3`);
      console.log(res);
    ...
    async searchUser() {
      if (this.tyPe == 1) {
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.curr}&type=3&unitName=${this.unitName}&bottleType=${this.bottleType}&licence=${this.licence}&provinceCode=${this.codes}&cityCode=${this.citys}&areaCode=${this.areas}`
        );
        console.log(res);
        ...
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.curr}&type=3&unitName=${this.unitName}&bottleType=${this.bottleType}&licence=${this.licence}&provinceCode=${this.codes}&cityCode=${this.citys}&areaCode=${this.areaCode}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
        ...
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.curr}&type=3&unitName=${this.unitName}&bottleType=${this.bottleType}&licence=${this.licence}&provinceCode=${this.provinceCode}&cityCode=${this.cityCode}&areaCode=${this.areaCode}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
        ...
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.curr}&type=3&unitName=${this.unitName}&bottleType=${this.bottleType}&licence=${this.licence}&provinceCode=${this.codes}&cityCode=${this.cityCode}&areaCode=${this.areaCode}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
    ...
    async getUserlist() {
      ...
      if (this.tyPe == 1) {
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.page}&type=3&unitName=${this.unitName}&bottleType=${this.bottleType}&licence=${this.licence}&provinceCode=${this.codes}&cityCode=${this.citys}&areaCode=${this.areas}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
        ...
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.page}&type=3&unitName=${this.unitName}&bottleType=${this.bottleType}&licence=${this.licence}&provinceCode=${this.codes}&cityCode=${this.citys}&areaCode=${this.areaCode}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
        ...
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.page}&type=3&unitName=${this.unitName}&bottleType=${this.bottleType}&licence=${this.licence}&provinceCode=${this.provinceCode}&cityCode=${this.cityCode}&areaCode=${this.areaCode}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
        ...
        const res = await this.$http.get(
          `/unit/findPage?rows=${this.rows}&page=${this.page}&type=3&unitName=${this.unitName}&bottleType=${this.bottleType}&licence=${this.licence}&provinceCode=${this.codes}&cityCode=${this.cityCode}&areaCode=${this.areaCode}`
        );
        console.log(res);
        this.userlist = res.data.data.list;
        this.total = res.data.data.totalCount;
