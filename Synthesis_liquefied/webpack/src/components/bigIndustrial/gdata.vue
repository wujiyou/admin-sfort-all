...
import barChatg from "../bigIndustrial/gdataComponents/barChatg";
import barChatga from "../bigIndustrial/gdataComponents/barChatga";
import stackChart from "../bigIndustrial/gdataComponents/stackChart";
import pieChart from "../bigIndustrial/gdataComponents/pieChart";
import pieChartg from "../bigIndustrial/gdataComponents/pieChartg";
import horseRace from "../bigIndustrial/gdataComponents/horseRace";
import horseRace1 from "../bigIndustrial/gdataComponents/horseRace1";
...
export default {
  ...
  props: {
    ...
    bg: {
      type: String,
      default:" background:url('/bg15.png') no-repeat;background-size:100% 100%;",
    },
    stackChartSty: {
      type: String,
...
.liqCon {
  ...
  /* background: url("../../../static/images/bg15.png") no-repeat; */
