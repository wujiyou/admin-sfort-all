<template>
  <div>
    <div style="background:white;width:99.1%;padding-left:15px">
      <my-bread level1="气瓶登记" level2="档案新增" level3="车用气瓶"></my-bread>
    </div>
    <el-card class="box-card" style="margin:20px 20px 0 20px;">
        ...
        <el-form :model="form" :rules="rules" ref="form">
          ...
          <template>
            ...
            <el-button
              ...
              size="small"
            >
              <i style="padding-right:10px" class="el-icon-plus"></i>新增气瓶信息
            </el-button>
          </template>
          ...
          <el-col :span="24">
            ...
            <el-col :span="8">
              <el-form-item class="red_s" label="制造单位:" label-width="140px" prop="makeInfo">
                <el-input v-model="last.makeInfo" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
          <el-col :span="24">
      ...
      <el-dialog width="60%" title="修改信息" :visible.sync="dialogFormVisibleEdit">
        <el-form :model="editUserForm" :rules="rules" ref="editUserForm">
          ...
          <template>
            ...
            <el-button type="success" class="instt" @click="showAddUserDiaaas()" size="small">
              <i style="padding-right:10px" class="el-icon-plus"></i>修改气瓶信息
            </el-button>
          </template>
      ...
      <el-dialog width="60%" title="添加信息" top="2vh" :visible.sync="dialogFormVisibleEdits">
        <el-form :model="lasts" :rules="rules" ref="form">
          <el-col :span="24">
            <el-col :span="8">
              <el-form-item class="red_s" label="设备代码:" label-width="140px" prop="sbCode">
                <el-input disabled v-model="lasts.sbCode" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <!-- <el-col :span="2">
              <el-button
          ...
          <el-col :span="24">
            <el-col :span="8">
              <el-form-item class="red_s" label="检查日期:" label-width="140px" prop="checkData">
                <el-date-picker
                  type="date"
                  placeholder="填写日期"
            ...
            <el-col :span="8">
              <el-form-item class="red_s" label="下次检查日期:" label-width="140px" prop="nextCheckData">
                <el-date-picker
                  type="date"
                  placeholder="填写日期"
      ...
      <el-dialog width="60%" :visible.sync="pdfindex">
        <div class="indexs">
          <p class="imgs">
      ...
      >
        <el-form :model="forma" :rules="rulses" ref="forma">
            ...
            <el-col :span="8">
              <el-form-item label-width="140px" label="行政省份:">
                <el-select
                  ...
                  @change="functions2(forma.provinceCode)"
                  :disabled="showCmd"
                  placeholder="请选择"
                >
                  <el-option
          ...
          <el-col :span="24">
            ...
            <el-col :span="8">
              <el-form-item label="详细地址:" class="red_s" label-width="140px" prop="address">
          ...
          <el-col :span="24">
            ...
            <el-col :span="8">
              <el-form-item label="检验核准证书编号:" class="red_s" label-width="140px" prop="licence">
                <el-input v-model="forma.licence" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="统一社会信用代码:" class="red_s" label-width="140px" prop="code">
            ...
            <el-col :span="8">
              <el-form-item label-width="140px" label="行政省份:">
                <el-select
                  ...
                  @change="functions2(forms.provinceCode)"
                  :disabled="showCmd"
                  placeholder="请选择"
                >
                  <el-option
            ...
            <el-col :span="8">
              <el-form-item label-width="140px" label="市级区域:">
                <el-select
                  ...
                  @change="functions1(forms.cityCode)"
                  :disabled="showCmd_1"
                  placeholder="请选择"
                >
                  <el-option
      ...
      <!-- 登记表打印下载 -->
      <el-dialog width="60%" top="3vh" title="登记表预览下载" :visible.sync="dengtabledialogFormVisible">
        <el-form :model="dengtable" :rules="rules" ref="dengtable">
          <el-col :span="24">
            <el-col :span="8">
              <el-form-item class="red_s" label="登记类别:" label-width="140px" prop="regType">
            ...
            <el-col :span="8">
              <el-form-item class="red_s" label="车辆类型:" label-width="140px" prop="carType">
                <el-select style=" width: 100%" v-model="dengtable.carType" :validate-event="false">
                  <el-option
                    v-for="item in selects4"
                    :key="item.id"
                    :label="item.orders"
            ...
            <el-col :span="8">
              <el-form-item class="red_s" prop="zoneId" label-width="140px" label="市级区域:">
                <el-select
                  ...
                  @clear="loadUserList()"
                  clearable
                  v-model="dengtable.zoneId"
                  @input="searchUser()"
                  @change="function1(dengtable.zoneId)"
                  placeholder="请选择城市"
                  :disabled="showCmd_1"
                >
                  <el-option
          ...
          <el-col :span="24">
            <el-col :span="11">
              ...
              <!-- <el-form-item class="red_s" label="设备品种:" label-width="140px" prop="equType">
                <el-select style=" width: 100%" v-model="dengtable.equType" :validate-event="false">
                  <el-option
                    v-for="item in selects1"
                    :key="item.id"
                    :label="item.orders"
          ...
          <el-col :span="24">
            <el-col :span="11">
              <el-form-item class="red_s" label="统一社会信用代码:" label-width="140px" prop="creditCode">
                <el-input v-model="dengtable.creditCode" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="2">&nbsp;</el-col>
            <el-col :span="11">
              <el-form-item label="邮政编码:" label-width="140px">
                <el-input v-model="dengtable.postNum" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
          ...
          <el-col :span="24">
            <el-col :span="11">
              <el-form-item class="red_s" label="车牌号:" label-width="140px" prop="carNum">
                <el-input v-model="dengtable.carNum" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="2">&nbsp;</el-col>
            <el-col :span="11">
              <el-form-item class="red_s" label="车辆VIN码:" label-width="140px" prop="vinNum">
                <el-input v-model="dengtable.vinNum" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
          ...
          <el-col :span="24">
            <el-col :span="11">
              <el-form-item class="red_s" label="登记证编号:" label-width="140px" prop="regId">
                <el-input v-model="dengtable.regId" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="2">&nbsp;</el-col>
            <el-col :span="11">
      ...
      <!-- 使用标志 -->
      <el-dialog width="60%" top="3vh" title="使用标志预览下载" :visible.sync="dialogbiaozhiVisibleAddbb">
        <el-form :model="sybiaoz" :rules="rules" ref="sybiaoz">
          <el-col :span="24">
            <el-col :span="11">
              <el-form-item class="red_s" label="使用单位:" label-width="140px" prop="useName">
                <el-input v-model="sybiaoz.useName" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="1">&nbsp;</el-col>
            <el-col :span="11">
              <el-form-item class="red_s" label="车牌号:" label-width="140px" prop="carNum">
                <el-input v-model="sybiaoz.carNum" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
          <el-col :span="24">
            <el-col :span="11">
              <el-form-item class="red_s" label="气瓶编号:" label-width="140px" prop="gasId">
                <el-input v-model="sybiaoz.gasId" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="1">&nbsp;</el-col>
            <el-col :span="11">
              <el-form-item class="red_s" label="气瓶数量:" label-width="140px" prop="num">
                <el-input v-model="sybiaoz.num" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
          <el-col :span="24">
            <el-col :span="11">
              <el-form-item class="red_s" label="充装介质:" label-width="140px" prop="volume">
                <el-input v-model="sybiaoz.medium" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="1">&nbsp;</el-col>
            <el-col :span="11">
              <el-form-item class="red_s" label="登记机关:" label-width="140px" prop="certification">
                <el-input v-model="sybiaoz.certification" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
          <el-col :span="24">
            <el-col :span="11">
              <el-form-item class="red_s" label="检测单位:" label-width="140px" prop="checkName">
                <el-input v-model="sybiaoz.checkName" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="1">&nbsp;</el-col>
            <el-col :span="11">
              <el-form-item class="red_s" label="登记证号:" label-width="140px" prop="regId">
                <el-input v-model="sybiaoz.regId" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
          <el-col :span="24">
            <el-col :span="11">
              <el-form-item class="red_s" label="下次检验日期:" label-width="140px" prop="nextCheckData">
                <el-input v-model="sybiaoz.nextCheckData" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="1">&nbsp;</el-col>
            <el-col :span="11">
              <el-form-item class="red_s" label="容积（L）:" label-width="140px" prop="carNum">
                <el-input v-model="sybiaoz.volume" autocomplete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-col>
        </el-form>
        <p style="text-align: center;" slot="footer" class="dialog-footer">
          <el-button @click="dialogbiaozhiVisibleAddbb = false">取 消</el-button>
          <el-button
            :loading="loadingbutss"
            type="primary"
            @click="savencftpgetss()"
          >{{loadingbuttextss}}</el-button>
          <el-button type="primary" @click="ncftpgetss()">下载pdf文档</el-button>
          <el-button type="primary" @click="previewFile()">预览</el-button>
        </p>
      </el-dialog>
    </el-card>
...
export default {
  ...
  data() {
    return {
      ...
      dengtabledialogFormVisible: false, //登记表对话框
      dialogbiaozhiVisibleAddbb: false, //使用标志
      loadingbuttext: "保存登记证",
      loadingbuttexts: "保存登记表",
      loadingbuttextss: "保存使用标志",
      loadingbut: false, //审核提交加载中
      loadingbuts: false, //审核提交加载中
      loadingbutss: false, //审核提交加载中
      pdfindex: false,
  ...
  methods: {
    ...
    async ncftpgetss() {
      ...
      const res = await this.$http
        .post(
          `CarInspector/word/mark/${this.regsId}`,
    ...
    savencftpgetss() {
      this.loadingbutss = true;
      this.loadingbuttextss = "加载中...";
      this.$http.get(`carword/mark?id=${this.shiyongId}`).then((res) => {
        console.log(res);
        if (res.data.code == 1) {
          this.$message({
            type: "warning",
          ...
          this.loadingbutss = false;
          this.loadingbuttextss = "保存使用标志";
    ...
    async sybiaozhi(row) {
      console.log(row);
      this.shiyongId = row.id;
      this.regsId = row.regId;
      const res = await this.$http.get(`carword/markShow?id=${row.id}`);
      console.log(res);
      if (res.data.code == 1) {
        this.$message({
          type: "error",
        ...
        this.dialogbiaozhiVisibleAddbb = false;
      } else {
        this.dialogbiaozhiVisibleAddbb = true;
        this.sybiaoz = res.data.data;
        this.savencftpgetss();
      }
    },
    ...
    async ncftpgets() {
      ...
      const res = await this.$http
        .post(
          `/CarInspector/word/list/${this.regsId}`,
          { headers: "application/x-download" },
          { responseType: "blob" }
        )
        .then((response) => {
    ...
    savencftpgets() {
      ...
      this.$http
        .get(`/carword/word/list?id=${this.dengtableId}`)
        .then((res) => {
          console.log(res);
          if (res.data.code == 1) {
            this.$message({
    ...
    async agricultural(row) {
      ...
      const ress = await this.$http.get(
        `/carword/showTable?&id=${this.dengtableId}`
      );
      console.log(ress);
      ...
      if (this.tyPe == 0) {
        if (this.last.makeData == "") {
          ...
          const res = await this.$http.get(
            `/IDGenerate/carCode?city=${this.form.zoneId}&equType=${this.form.equType}&makeData=${data}`
          );
          console.log(res);
    ...
    async Regtions() {
      let city = sessionStorage.getItem("cityCode"); //市code
      console.log(this.lasts.makeData);
      if (this.lasts.makeData == "") {
        this.$message({
          type: "error",
          message: "请先填写制造日期",
        });
        ...
        const data =
          this.lasts.makeData.getFullYear() +
          "-" +
          0 +
          (this.lasts.makeData.getMonth() + 1) +
          "-" +
          this.lasts.makeData.getDate();
        // let data=new Date(this.last.makeData).toLocaleDateString().replace(/\//g, '-')
        const res = await this.$http.get(
          `/IDGenerate/carCode?city=${city}&equType=${this.lasts.equType}&makeData=${data}`
        );
        console.log(res);
        this.lasts.sbCode = res.data;
      }
    },
    // 批量删除请求数据
    showDeleUserMsgBox() {
    ...
    async EditUser() {
      ...
      const user = Object.assign(this.editUserForm, this.lasts);
      console.log(user);
      const res = await this.$http.post(`/carDoucument/update`, user);
      console.log(res);
      if (res.data.code === 200) {
        // 回到第一页展示
        //this.pagenum = 1;
    ...
    async diaoyong() {
      const res = await this.$http.get(
        `carDoucument/show?regId=${this.xiugai}`
      );
    ...
    async showEdituser(user) {
      console.log(user);
      this.editUserForm.idb = user.id;
      console.log(this.editUserForm.idb);
      this.xiugai = user.regId;
      // 2.添加对话框
    ...
    async AddUser() {
      ...
      this.$refs.form.validate(async (valid) => {
        ...
        if (this.form.equType.length == 1) {
          this.form.equType = this.form.equType[0];
          console.log(this.form.equType);
        } else {
          this.form.equType = this.form.equType[1];
          console.log(this.form.equType);
        }
    ...
    async showAddUserDiaaas() {
      ...
      console.log(this.userlists);
      if (this.userlists != 0) {
        this.lasts = this.userlists[0];
        this.lasts.CId = this.userlists[0].id;
