...
export default {
  ...
  methods: {
    ...
    mapChart() {
      ...
      var mapdata = [];
      var _that = this;
      let params = `city/${_that.cityMap[_that.cityName]}.json`;
      var _that = this;
      $.getJSON(
        ...
        function (data) {
          ...
          _that.$echarts.registerMap(_that.cityName, data);
          _that.renderMap(_that.cityName, d);
          _that.city = "";
        }
      );
    ...
    renderMap(map, data, obj2) {
      ...
      var option = {
        ...
        //             $.ajax({
        //               type: "POST",
        //               url: "http://39.98.74.46:8081/stats/findByChinese",
        //               async: false,
    ...
    renderMapData(childNode) {
      ...
      if (childNode.type === "P" || childNode.type === "C") {
        ...
        $.getJSON(
          ...
          function (data) {
            data.features.forEach((v) => {
              if (childNode.name === v.properties.name) {
        ...
        console.log("-------------------");
        let gt = cityDeta.geometry.coordinates[0][0][0][0];
        let lt = cityDeta.geometry.coordinates[0][0][0][1];
        if (this.areaType == 2) {
          this.createMap(
            gt,
            lt,
        ...
        this.$nextTick(() => {
          ...
          this.$nextTick(() => {
            this.myMapChart = this.$echarts.init(
              document.getElementById(_that.mapId)
            );
