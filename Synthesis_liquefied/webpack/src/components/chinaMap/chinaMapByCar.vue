    ...
    <div class="appContainer" @click="hideMenu">
      <el-col :span="24">
        <div class="box">
          ...
          <div v-if="isMap" id="main2" :style="heig"></div>
        </div>
      </el-col>
    </div>
...
export default {
  ...
  mounted() {
    this.myMapChart = this.$echarts.init(document.getElementById("main2"));
    this.mapChart();
  },
  beforeDestroy() {},
  methods: {
    ...
    mapChart() {
      ...
      var _that = this;
       this.$http.get(`/stats/findByChinese`,{params:{provinceCode:430000}}).then(res=>{
              console.log(res);
            })
      ...
      $.getJSON(
        ...
        function (data) {
          ...
          if (_that.city != "") {
            ...
            // 绘制地图
            _that.renderMap("china", d, _that.obj);
          }
    ...
    createMap(gt, lt, cityName) {
      this.map = new BMap.Map("main2");
      let map = this.map;
    ...
    renderMap(map, data, obj2) {
      ...
      var option = {
        ...
        //               $.ajax({
        //                 type: "POST",
        //                 url: "http://192.168.0.7:8081/stats/findByChinese",
        //                 async: false,
        //                 contentType: "application/json",
        //                 data: JSON.stringify(map),
        //                 success: function (res) {
        ...
        //         (v) => _that.treeMap.childNode.name == v) >= 0
        //     ) {
        //       console.log(_that.treeMap.childNode.name);
        //       console.log("-----------sssssss-----------");
        //       let dd = "";
