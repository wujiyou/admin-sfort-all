<template>
  <div>
    ...
    <el-card class="box-card" style="margin:20px 20px 0 20px;">
      ...
      <el-row>
        <el-col :span="24">
          <p style="border-bottom:1px solid #ece8e8;padding-bottom:15px;padding-left:15px">查询信息</p>
        </el-col>
      ...
      <el-col style="margin-bottom:10px;margin-top:10px;margin-left:20px" :span="24">
