<template>
  <el-header
    class="header-flex"
    :style="{width: (getCollapseState == false)?'calc(100% - 240px)':'calc(100% - 64px)',
                 left: (getCollapseState == true)?'64px':'',
                 backgroundColor: getHeaderBColor,
                 color: getHeaderColor}"
  >
    <div class="head_top">
       <div class="head_top1"><p style="color:white;font-weight:bold;">
          <span > <i style="font-size:18px;margin-right:10px;" class="el-icon-help"></i>气瓶综合 - 监管平台</span>
        </p></div>
        
      
      <!--左侧导航收缩按钮-->
      <div @click="isOpen" class="head_top1">
        <p multiBtn>
          <i
            class="icon_size"
