  ...
  methods: {
    ...
    async searchUser() {
      const res = await this.$http.get(
        `/public/gas/manageGasBasicCylinder/list?pageSize=${this.pageSize}&currPage=${this.page}&gasId=${this.gasId}&useStatus=${this.siteId}`
      );
    ...
    async getUserlist() {
      const res = await this.$http.get(
        `/public/gas/manageGasBasicCylinder/list?pageSize=${this.pageSize}&currPage=${this.currPage}&gasId=${this.gasId}&useStatus=${this.siteId}`
      );
      // &name=${this.name}
      console.log(res);
      this.userlist = res.data.data.list;
