      ...
      <div>
        <template>
          ...
          >
            ...
            <el-table-column prop="originalDepartment" label="原部门" show-overflow-tooltip></el-table-column>
            <el-table-column prop="originalPosition" label="原岗位" show-overflow-tooltip></el-table-column>
            <el-table-column prop="originalSuperior" label="原部门上级领导" show-overflow-tooltip></el-table-column>
            <el-table-column prop="newDepartment" label="新部门" show-overflow-tooltip></el-table-column>

            <el-table-column prop="newPosition" label="新岗位" show-overflow-tooltip></el-table-column>
            <el-table-column prop="newSuperior" label="新部门上级领导" show-overflow-tooltip>
            </el-table-column>
  ...
  methods: {
    ...
    async getUserlist() {
      const res = await this.$http.get(
        `/arrival/all?pageSize=${this.rows}&currPage=${this.page}&name=`
      );
      console.log(res);
