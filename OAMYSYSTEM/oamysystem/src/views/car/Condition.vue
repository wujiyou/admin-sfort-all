  ...
  <div class="box-card">
    ...
    <el-col :span="24" class="topkq">
      ...
      <div class="top_text">
        ...
        <span style="display:inline-block;margin-left:10px;margin-top:10px;margin-bottom:10px">
          <el-checkbox v-model="zhi" label="正在使用"></el-checkbox>
        </span>
        <span style="display:inline-block;margin-left:10px;margin-top:10px;margin-bottom:10px">
          <el-checkbox v-model="zhi" label="已完成"></el-checkbox>
        </span>
      ...
      <div>
        <template>
          ...
          >
            ...
            <el-table-column prop="address" label="用车原因" show-overflow-tooltip></el-table-column>
            <el-table-column prop="num" label="用车人" show-overflow-tooltip></el-table-column>
            <!-- <el-table-column prop="checkName" label="原部门上级领导" show-overflow-tooltip></el-table-column> -->
            <el-table-column prop="useName" label="用车状态" show-overflow-tooltip></el-table-column>

            <el-table-column prop="certification" label="开始时间" show-overflow-tooltip></el-table-column>
            <el-table-column prop="useName" label="结束时间" show-overflow-tooltip></el-table-column>
          </el-table>
        </template>
        <el-pagination
