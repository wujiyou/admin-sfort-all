      ...
      <div>
        <template>
          ...
          >
            ...
            <el-table-column prop="address" label="产品型号" show-overflow-tooltip></el-table-column>
             <el-table-column prop="address" label="库存数量" show-overflow-tooltip></el-table-column>
